...
return [
    'api' => [
        ...
        */
        ...
        'title' => 'Berbagi pakai data Indeks Pembangunan Kebudayaan (IPK)',
    ],
    ...
    */
    ...
    'tags_sorter' => env('L5_SWAGGER_TAGS_SORTER', 'alpha'),
    ...
    */
     ...
     */
    'constants' => [
        'L5_SWAGGER_CONST_HOST' => env('L5_SWAGGER_CONST_HOST', 'https://ipk.kemenbud.go.id'),
    ],
];
