                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="file-item">
                                    <span class="btn label-pdf">Data Hasil Perhitungan IPK Nasional 2018 - 2022</span>
                                    <a href="{{ asset('assets/pdf/00 - Nasional 2018-2022.pdf') }}" class="btn btn-download" target="_blank">@include('icons/pdf-icon')</a>
                                    <a href="{{ asset('assets/excel/00 - Nasional 2018-2022.xlsx') }}" class="btn btn-downloadexc" target="_blank">@include('icons/excel-icon')</a>    
                                    </div>
                                    <div class="file-item">
                                    <span class="btn label-pdf">Data Hasil Perhitungan IPK Nasional 2023</span>
                                    ...
                                    <a href="{{ asset('assets/pdf/1001. Indonesia - 2023.pdf') }}" class="btn btn-downloadexc" target="_blank">@include('icons/excel-icon')Data Hasil Perhitungan IPK Nasional 2023</a>
                                    -->
                                </div>
                            </div>
                        </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        function generateDescription(item, index) {
                            if (year == 2024) {
                                description +=
                                    `<div class="col-md-6 pt-5"><div style="padding-bottom:15px;"><h6 class="fw-bold"> Indikator ${item.indicator_code} <i class="bi bi-info-circle" style="cursor: pointer;" tabindex="0" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-trigger="hover focus" data-bs-title="Metadata ${item.indicator_description}" data-bs-html="true" data-bs-content="<div class='text-center'><img src='/assets/img/metadata/${item.indicator_code}.jpg' class='img-fluid mb-2' style='width: 100%; max-width: 900px;'><br><a href='/assets/pdf/metadata-indikator-IPK-2024.pdf' target='_blank' class='btn btn-primary btn-sm text-white' style='text-decoration: none;'><i class='bi bi-download'></i> Unduh Dokumen Metadata</a></div>"></i></h6></div><p>${item.indicator_description}</p></div>
