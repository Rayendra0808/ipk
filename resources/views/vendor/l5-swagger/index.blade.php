...
window.onload = function() {
  ...
  const ui = SwaggerUIBundle({
    ...
    operationsSorter: function(a, b) {
        var aDesc = a.get("operation").get("description") || "";
        var bDesc = b.get("operation").get("description") || "";
        return aDesc.localeCompare(bDesc);
    },
    tagsSorter: {!! isset($tagsSorter) ? '"' . $tagsSorter . '"' : '"' . config('l5-swagger.tags_sorter') . '"' !!},
